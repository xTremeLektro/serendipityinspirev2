...
const AboutUsPage: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8 bg-white dark:bg-black text-gray-800 dark:text-gray-200">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-12 text-gray-800 dark:text-white">Sobre Nosotros</h1>

      <section className="company-intro mb-16 p-8 bg-gray-100 rounded-lg shadow-sm dark:bg-gray-800 dark:shadow-lg">
        <h2 className="text-3xl md:text-4xl font-semibold mb-6 text-gray-700 dark:text-gray-100">Nuestra Empresa</h2>
      ...
      <section className="text-gray-800 dark:text-gray-200">
        <h2 className="text-3xl md:text-4xl font-semibold text-center mb-10 text-gray-700 dark:text-gray-300">Nuestro Equipo</h2>
        <div className="team-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="team-member flex flex-col items-center text-center p-8 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-700 dark:shadow-xl dark:hover:shadow-2xl">
            ...
            <h3 className="text-xl font-bold mb-2 text-gray-800 dark:text-white">Nombre del Miembro 1</h3>
            <p className="text-md text-gray-600 mb-3 dark:text-gray-400">Fundador/Diseñador Principal</p>
          ...
          <div className="team-member flex flex-col items-center text-center p-8 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-700 dark:shadow-xl dark:hover:shadow-2xl">
            ...
            <h3 className="text-xl font-bold mb-2 text-gray-800 dark:text-white">Nombre del Miembro 2</h3>
            <p className="text-md text-gray-600 mb-2 dark:text-gray-400">Diseñador Senior</p>
