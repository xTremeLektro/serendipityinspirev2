...
export default async function PaginaDashboardAdmin() {
  ...
  const managementSections = [
    ...
    },
    {
      ...
      description: 'Gestiona los proyectos que se muestran en el sitio.',
    },
    {
      title: 'Servicios',
      href: '/admin/services',
    ...
    },
    {
      ...
      description: 'Revisa los envíos de formularios de contacto.',
    },
    {
      title: 'Presupuestos',
      href: '/admin/budget',
      ...
      description: 'Revisa los envíos de formularios de presupuestos.',
    },
    {
      title: 'FAQ',
      href: '/admin/faq',
      ...
      description: 'Gestiona las preguntas frecuentes (Futuro).',
    },
    {
      title: 'Blog',
      href: '/admin/blog',
      ...
      description: 'Gestiona las publicaciones del blog (Futuro).',
    },
  ]
    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <h1 className={`text-3xl font-bold text-gray-900 ${eduNSW.className}`}>Panel de Administracion</h1>
