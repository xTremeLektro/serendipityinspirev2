...
export default function Home() {
  return (
    <div className="container mx-auto px-4">
      ...
      {/* Project Previews */}
      <section className="py-12 bg-white dark:bg-black text-gray-800 dark:text-white">
        <h2 className="text-3xl font-bold text-center mb-8">Nuestros Proyectos Destacados</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Placeholder Project Card 1 */}
          <div className="project-card border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-lg dark:shadow-xl transform transition duration-300 hover:scale-105 hover:shadow-xl cursor-pointer bg-white dark:bg-gray-800">
          ...
          <div className="project-card border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-xl cursor-pointer bg-white dark:bg-black">
        ...
        <div className="text-center mt-8">
          <Link href="/portfolio" className="text-blue-600 dark:text-blue-400 hover:underline text-lg">Ver Portfolio Completo</Link>
        </div>
      </section>

      {/* Call to Action for About Us */}
      <section className="py-12 text-center bg-white dark:bg-black text-gray-800 dark:text-white">
      ...
      <section className="py-12 text-center bg-gray-100 dark:bg-black dark:text-white">
